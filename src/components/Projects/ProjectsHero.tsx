...
export default function ProjectsHero() {
  return (
    <section
      className="relative min-h-[70vh] sm:h-[80vh] w-full bg-cover bg-center bg-no-repeat flex items-center justify-center text-white px-4 sm:px-8 lg:px-24"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-3xl">
        ...
        >
          Une sélection de réalisations qui incarnent notre exigence, notre vision et notre savoir-faire.
        </motion.p>
      </div>
    </section>
  )
