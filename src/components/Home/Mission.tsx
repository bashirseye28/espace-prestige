    ...
    <section className="bg-[#F9F5FC] text-text py-20 px-4 sm:px-8 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-muted max-w-3xl mb-12"
        >
