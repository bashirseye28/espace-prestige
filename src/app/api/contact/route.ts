...
export async function POST(req: Request) {
  ...
  <div style="font-family: Inter, sans-serif; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px; max-width: 600px; margin: auto;">
    ...
    <div style="font-size: 14px; color: #222;">
      ...
      <p style="font-weight: 600; margin: 0;">Groupe Espace Prestige</p>
      <p style="margin: 0;">Architecture & Design Studio</p>
      <p style="margin: 0 0 16px;">Votre partenaire pour des projets haut de gamme</p>
